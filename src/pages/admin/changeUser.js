      ...
      <>
        <div className={'bg-white bg-opacity-0 mt-1 ml-0.5'}>
          ...
          >
            ...
            <h1 className={'text-3xl m-4 mt-0 w-fit'}>Wijzigen</h1>
          </div>
          ...
          >
            ...
            >
              <p className={'mt-4'}>Gebruiker wijzigen</p>
            </div>
            ...
            >
              <button
                type="button"
                className={
                  'flex items-center bg-[#ff0000] border-2 border-[#ff0000] text-white px-[15px] py-[18px] text-center no-underline text-[16px] mx-[4px] my[2px] cursor-pointer rounded-[5px] mr-[10px]'
                }
              >
