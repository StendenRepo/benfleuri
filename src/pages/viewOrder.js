                                ...
                                <div className={`flex flex-col lg:flex-row justify-between`}>
                                    ...
                                    <div className={`flex flex-col mt-[3%] w-[95px]`}>
                                        ...
                                        >
                                            ...
                                            <option selected={order.paymentMethod === "BY_INVOICE"}
                                                    value="by_invoice">Factuur
                                            </option>
                                            <option selected={order.paymentMethod === "CASH"} value="cash">Contant
                                            </option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div className={`flex-col w-[45%] mr-[2%] mt-[110px]`}>
                            ...
                            >
                                ...
                                <select required
                                        ...
                                        name="status"
                                        id="status">
                                    <option selected={order.orderState === "IN_PROGRESS"} value={"IN_PROGRESS"}>Gelevert
                                        maar niet thuis
                                    </option>
                                    <option selected={order.orderState === "OPEN"} value={"OPEN"}>Open</option>
                                    <option selected={order.orderState === "DELIVERED"} value={"DELIVERED"}>Verzonden
                                    </option>
                                ...
                                <select required
                                        ...
                                        id="processEmployee">
                                    {findAllEmployees.map(f => {
                                        return <option selected={f.id === assignedEmployee.id} value={f.id}>{f.name}</option>
                                    })}
                                </select>
