...
function PillLabel({ type }) {
  ...
  return <div className={colorStyle}>{text}</div>;
}
    ...
    <div className="inline-block min-w-full">
      ...
      >
        ...
        <div className="gap-x-[5px] flex">
          ...
          <div className="items-stretch flex flex-row">
            <input
              className="text-sm rounded font-['Roboto'] border-[1px] border-black bg-white text-black"
              type="date"
            />
          </div>
          <WhiteButton>
        ...
        <div className="h-full">
          <div className="relative h-full">
            <Listbox.Button
              className={
                corners +
                ' h-full border-black w-full cursor-default ' +
...
function SortDropdown() {
  return (
    <Menu
      as="div"
      className="h-full border-y-[1px] border-r-[1px] border-black rounded-r"
    >
      <div>
        <Menu.Button className=" h-full w-full py-[10px] px-[20px] text-sm font-bold font-['Roboto'] bg-white text-black">
          Sorteer op
          <ChevronDownIcon
            className="inline -mr-1 ml-2 h-5 w-5"
            aria-hidden="true"
          />
        </Menu.Button>
      </div>
